...
evidence:
  ...
  - every form on the site is inert (forms_dead=200)
  ...
  - "every form on the site is inert" is no longer true as written. The
    ...
    and it fires a `list-signup` event. forms_dead=200 counts the STATIC
  ...
  - UPDATED 2026-09-25: forms_dead moved 195 to 196. The one addition is
    ...
    footer newsletter form as every other page, nothing new in kind.
  - UPDATED 2026-09-25: forms_dead moved 196 to 197. The one addition is
  ...
  - UPDATED 2026-09-25: forms_dead moved 199 to 200. The one addition is
    the new garage-deck.html (BACKLOG-2026-09-07.md B9, the fifth and
    last room deck, closing B9), same inert footer newsletter form,
    nothing new in kind.
  ...
  - KNOWN AND NOT FIXED: with JavaScript off the form is inert with no
    ...
    because the footer markup is baked into 193 page files across several
