...
evidence:
  ...
  - ops/state.json social_units=5040 authored and unused
...
is 5,040, the true combined figure: the 4,205 correction above and this
one both partial views of the same undercount, neither ever real on its
own.
