...
evidence:
  ...
  - every form on the site is inert (forms_dead=198)
  ...
  - "every form on the site is inert" is no longer true as written. The
    ...
    and it fires a `list-signup` event. forms_dead=198 counts the STATIC
  ...
  - UPDATED 2026-09-25: forms_dead moved 197 to 198. The one addition is
    ...
    third of five room decks), same inert footer newsletter form, nothing
    new in kind.
