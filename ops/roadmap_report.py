...
def build(edition: int = 8) -> tuple[str, str, dict]:
    ...
    if full:
        ...
        L += ["DECISION GATES, and where each stands", "",
              ...
              "  G1  Under 500 organic visits a month and nothing further has sold",
              "      beyond the single $19 of 2026-08-21, by Aug 2027, and digital",
              "      stops being a target bearing route.",
              f"      STATUS: about {daily*30:.0f} visits a month, nothing further",
              "      has sold beyond the single $19 of 2026-08-21.", "",
