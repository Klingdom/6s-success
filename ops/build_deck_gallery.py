...
<section class="section" style="padding-top:0">
  <div class="wrap narrow">
    ...
    nineteen rooms, the <a href="shop.html">Whole House Print Pack</a> is a
    different product: the six-pass instruction steps for all 114 micro
    zones, not this diagnostic game. Same trim size and card stock, so a
    mixed pile still prints and handles the same.</p>
...
.chips .n{{font-variant-numeric:tabular-nums;margin-left:3px}}
