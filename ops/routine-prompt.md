...
- No stranger has bought yet. That is a starting position, not a finding, and it is where every business begins. Do not restate it as a caveat in reports, do not use it to talk down an opportunity, and do not make the reader of a dashboard wade through it. Work toward the first sale the way any business would: ship the thing, put it where buyers already are, and measure.
