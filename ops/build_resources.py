...
<!-- SIGNUP:BEGIN -->
<!-- Signup withdrawn 2026-08-23, corrected 2026-09-09: the from-address
     was already ours the next day, so a wrong-brand email is not the live
     defect. The instance-wide SMTP credential still belongs to Compassion
     Benchmark, a different business on the same shared Listmonk host, so
     every opt-in confirmation 553s and the visitor sees a 500. Restore
     ops/wire_signup.py once GitHub issue #15 (P0, decision) is resolved:
     a separate Listmonk instance for 6S, or the shared instance handed
     over to 6S's own sending identity. -->
<!-- SIGNUP:END -->
{FOOTER}
</body>
</html>"""
