...
def main():
    ...
    # one of the 190 site pages, not just the two this file writes. A
    # standalone run of this file (the way an operator actually reaches
    # for it, after a content.json edit) therefore strips the
    # cache-busting fingerprint off every page on the site, silently,
    ...
    # first; gate_generator_chains_fingerprint in preflight.py now
    # asserts every generator that chains build_avif.wire() also chains
    # this.
