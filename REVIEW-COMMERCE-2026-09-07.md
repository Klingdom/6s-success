...
C1-C3 first (they are revenue protection and they pay at any traffic). All
four *At* items (C4, C8, C11, C12, C13) are now done, 2026-09-21/22; section
7 is fully clear of *At* tier work. Remaining: C1/C2/R1-R4 need Stripe
credentials no sandbox here holds; C6-C7/C9/C10/C16/C17/C20 are background
hygiene or wait behind O1 (traffic) per this document's own ordering.
