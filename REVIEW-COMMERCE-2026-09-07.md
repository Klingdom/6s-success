...
above). Genuinely remaining: **C1/C2/R1-R4** need Stripe credentials no
sandbox here holds; **C6/C7/C9/C10/C20** are background hygiene or wait
behind O1 (traffic) per this document's own ordering, and none is picked up
yet.
