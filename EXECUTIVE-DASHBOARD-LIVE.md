...
> Generated 2026-08-31 11:03 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 359 of 602 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `7eecfe9b` Retrospective, cycle 26: the product itself now has a test,  |
