...
> Generated 2026-09-17 17:54 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1255 of 2567 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `94f73b3c` Run preflight --deep to completion, the one check not exerci |
