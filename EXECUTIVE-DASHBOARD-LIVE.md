...
> Generated 2026-09-11 13:23 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 634 of 1473 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `fca54118` Log the accept-test split and regenerate the command deck |
