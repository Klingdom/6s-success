...
> Generated 2026-09-13 12:40 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 858 of 1800 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `229ebbff` Cut Chrome render timeouts from 600s/120s to 90s/30s per att |
