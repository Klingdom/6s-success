...
> Generated 2026-09-10 17:54 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 524 of 1310 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `15a19e1e` Regenerate the deck after the PM check-in |
