...
> Generated 2026-09-10 00:11 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 493 of 1255 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `61cb9362` Record the CI-red root-cause-and-fix in ops/NIGHTLY-LOG.md |
