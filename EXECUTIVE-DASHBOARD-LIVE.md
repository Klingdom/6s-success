...
> Generated 2026-09-04 04:08 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| **Revenue this month** | **$0 of $20,000 target (0.0%), carried forward from 2026-09-03 21:48 because this run could not reach Stripe** |
| | `............................` |
| **Paying customers** | 0 |
| **Email list** | 0 |
...
| Closed to date | 20 |
| Commits (7 days) | 447 of 813 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `5cb5e060` Correct 6.64: Phil's own concurrent fix landed first and wen |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 192 pages, 0 dead links, 4/4 legal pages, 189 disconnected forms |
...
| Zone reset videos | 114/114 short zone-reset videos, rendered, not posted anywhere yet (carried forward from 2026-09-03 21:48: build/video/*.mp4 is no longer tracked in git, so this could not be measured here) |
| Zone reset videos, photo-led | 2/110 eligible photo-led zone-reset videos, rendered, not posted anywhere yet (carried forward from 2026-09-03 21:48: build/video/*.mp4 is no longer tracked in git, so this could not be measured here) |
| Zone reset videos, 16:9 for YouTube | 114/114 horizontal zone-reset videos for YouTube, rendered, not posted anywhere yet (carried forward from 2026-09-03 21:48: build/video/*.mp4 is no longer tracked in git, so this could not be measured here) |
| Zone reset videos, narrated | 114/114 narrated zone-reset videos with real voice, rendered, not posted anywhere yet (carried forward from 2026-09-03 21:48: build/video/*.mp4 is no longer tracked in git, so this could not be measured here) |
...
- **Redeploy the site.** Production is serving an older build: 6 of 9 assets on the live homepage differ from this repository, and no zone page carries its photograph yet. The image is built and pushed to ghcr.io; the Redeploy button in Hostinger is the only step left. Until then 110 reviewed pictures and every fix since the last deploy reach nobody.
