...
> Generated 2026-09-14 10:26 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 968 of 1960 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `35b6b5f7` STATUS.md: record commerce-review fixes |
