...
> Generated 2026-09-26 10:28 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1093 of 3973 total |
| Working tree | clean, in sync |
| Last commit | `5a201da1` Regenerate the print manual and its publishable sibling: sta |
