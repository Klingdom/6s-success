...
> Generated 2026-09-10 19:43 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 537 of 1326 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `5b7a783d` PM check-in: two more cold-read candidates cleared clean, no |
