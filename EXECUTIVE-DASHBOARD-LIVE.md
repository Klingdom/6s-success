...
> Generated 2026-09-10 13:27 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 503 of 1279 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `0ee13b59` Merge concurrent cycle: nursery prompt negation fix |
