...
> Generated 2026-09-26 06:25 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1096 of 3952 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `dcb80d21` Widen split_negations() to catch bare 'nothing' mid-clause,  |
