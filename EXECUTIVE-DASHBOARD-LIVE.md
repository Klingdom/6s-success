...
> Generated 2026-09-02 09:54 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 425 of 730 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `fde3abf7` Preflight, the single gate, could crash outright: fix and ga |
