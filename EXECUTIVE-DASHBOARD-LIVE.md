...
> Generated 2026-09-17 12:57 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1249 of 2525 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `d9ee8ef3` Fix CI: build_resources.py and build_standards_page.py still |
