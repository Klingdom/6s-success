...
> Generated 2026-09-17 11:03 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1241 of 2514 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `6d2e9467` render_cards.py: stop deleting real screenshots over a missi |
