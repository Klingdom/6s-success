...
> Generated 2026-09-04 05:34 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 458 of 825 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `6f5092c9` Make the sitemap deterministic so CI stops failing on phanto |
