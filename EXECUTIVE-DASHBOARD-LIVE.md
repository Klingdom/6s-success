...
> Generated 2026-09-10 19:53 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 538 of 1328 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `131216e5` Fix accept_image.py negative-clause parser inverting an acce |
