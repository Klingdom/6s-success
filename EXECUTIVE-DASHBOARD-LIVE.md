...
> Generated 2026-08-31 14:31 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 404 of 666 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `2b1cf7e9` Add the execution directive, two operating plans, and a real |
