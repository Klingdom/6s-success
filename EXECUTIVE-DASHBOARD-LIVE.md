...
> Generated 2026-09-23 23:02 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1156 of 3586 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `fac8809a` Stop gate_indexable_pages_have_schema failing on temp probe  |
