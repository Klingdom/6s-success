...
> Generated 2026-08-30 23:03 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 330 of 562 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `0152fab` Regenerate the deck from the merged code |
