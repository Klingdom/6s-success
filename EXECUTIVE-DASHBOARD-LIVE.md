...
> Generated 2026-09-10 16:44 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 523 of 1304 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `3ea884e2` Regenerate the deck after preflight's own run |
