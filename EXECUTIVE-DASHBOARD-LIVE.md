...
> Generated 2026-09-25 01:26 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1094 of 3742 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `ac9cbb55` Close a recurring stale-handoff pattern with a cold-read led |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 200 pages, 0 dead links, 4/4 legal pages, 195 disconnected forms |
