...
> Generated 2026-09-03 21:47 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 436 of 792 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `b0b6303a` STATUS.md: record the Quest restore data-loss fix |
