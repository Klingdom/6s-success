...
> Generated 2026-09-23 18:10 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1152 of 3546 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `071ae114` Fix a live JS crash breaking mobile nav and hiding homepage  |
