...
> Generated 2026-09-22 23:34 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 26 |
| Commits (7 days) | 1178 of 3442 total |
| Working tree | clean, in sync |
| Last commit | `8bd79617` Fix D18 zone-entity-naming drift: VideoObject JSON-LD now de |
