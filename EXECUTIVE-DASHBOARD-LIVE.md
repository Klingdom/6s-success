...
> Generated 2026-09-07 18:27 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 392 of 1063 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `9d9fe22e` Regenerate build-id.txt after the shop.html JSON-LD fix |
...
| Zone reset videos, narrated | 11/114 narrated zone-reset videos with real voice, rendered, not posted anywhere yet |
