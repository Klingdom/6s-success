...
> Generated 2026-09-15 06:09 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 1031 of 2130 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `605a477c` PM check-in: preflight clean, issue #2 stale count corrected |
