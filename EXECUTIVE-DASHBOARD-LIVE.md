...
> Generated 2026-08-30 16:06 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 295 of 511 total |
| Working tree | clean, in sync |
| Last commit | `1c4054f` Eight more zones get a picture, and stop advertising the rej |
