...
> Generated 2026-09-06 23:57 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 452 of 978 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `257a9583` Fix shrink_sample.py's page-count safety check, which never  |
