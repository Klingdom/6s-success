...
> Generated 2026-09-25 01:14 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1100 of 3741 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `80e03242` Merge branch 'main' of https://github.com/Klingdom/6s-succes |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 205 pages, 0 dead links, 4/4 legal pages, 195 disconnected forms |
