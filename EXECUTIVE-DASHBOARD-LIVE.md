...
> Generated 2026-08-30 15:13 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 292 of 507 total |
| Working tree | clean, in sync |
| Last commit | `da1ea42` Say the zone's name once, the way the page says it |
