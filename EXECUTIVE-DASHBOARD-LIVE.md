...
> Generated 2026-09-17 14:23 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1250 of 2535 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `a539a37f` Fix test_publish_image_current.py: three tests asserting the |
