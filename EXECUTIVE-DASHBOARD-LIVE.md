...
> Generated 2026-09-09 01:16 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 446 of 1167 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `5a45a312` Fix the live MCP server serving all 114 zones stale since 20 |
