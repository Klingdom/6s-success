...
> Generated 2026-08-22 01:01 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Commits (7 days) | 133 of 139 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `3ca329e` Log the structured data cycle |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 161 pages, 0 dead links, 4/4 legal pages, 159 disconnected forms |
