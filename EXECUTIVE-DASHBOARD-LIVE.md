...
> Generated 2026-09-03 03:57 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 430 of 765 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `7c9732e4` Refresh the risk register: four CRITICAL entries were stale, |
