...
> Generated 2026-09-17 14:55 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1250 of 2542 total |
| Working tree | clean, in sync |
| Last commit | `cc8c48d8` Cold-read lane: review_heroes.py and root_causes.py confirme |
