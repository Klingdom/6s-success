...
> Generated 2026-08-31 17:56 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 395 of 654 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `16cb658d` Home Quest mobile: product target, UX architecture, migratio |
