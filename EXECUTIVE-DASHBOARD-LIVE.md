...
> Generated 2026-09-14 12:04 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 977 of 1973 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `2ddc2d99` Add social-drafts.yml to the cron-cadence coverage list |
