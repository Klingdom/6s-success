...
> Generated 2026-09-15 07:58 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 1042 of 2143 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `b17b5872` epubcheck now runs for real when the sandbox allows it |
