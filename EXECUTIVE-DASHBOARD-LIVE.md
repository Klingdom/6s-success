...
> Generated 2026-09-04 17:51 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 477 of 859 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `12cfb70b` Stop the sitemap chasing its own tail |
