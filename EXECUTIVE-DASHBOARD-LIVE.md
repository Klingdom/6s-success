...
> Generated 2026-09-10 16:30 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 522 of 1303 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `8d32776c` Regenerate the deck after the merge |
