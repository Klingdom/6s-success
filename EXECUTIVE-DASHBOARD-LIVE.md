...
> Generated 2026-09-25 22:05 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1087 of 3901 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `31b54ff7` PM check-in: cold-read lane continues, merge_cardtext.py cle |
