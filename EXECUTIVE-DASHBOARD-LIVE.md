...
> Generated 2026-08-29 23:46 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `8b2d4db` Local image generation works on the GPU, after two silent fa |
