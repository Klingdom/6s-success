...
> Generated 2026-09-11 11:49 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 622 of 1459 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `61b2b0eb` PM check-in: governance-doc cold-read lane one file further  |
