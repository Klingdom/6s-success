...
> Generated 2026-09-24 04:53 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1139 of 3612 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `22a29f10` Record why gate_publish_image_current now fails on HEAD |
