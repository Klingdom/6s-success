...
> Generated 2026-08-20 22:11 by `ops/dashboard.py`. Every figure is measured, not typed.
...
The site can take money for one thing: the two consulting packages, each a live Stripe Payment Link. The book, the manual, and every other listed product still cannot be bought. All 17 forms still hand off to email by hand instead of capturing a list. Widening what can actually be bought is what moves revenue now.
...
| Closed to date | 6 |
| Commits (7 days) | 114 of 120 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `1e15073` Remove a fabricated testimonial, and fix invisible headings  |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 17 pages, 1 dead links, 4/4 legal pages, 17 disconnected forms |
