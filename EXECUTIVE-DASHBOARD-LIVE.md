...
> Generated 2026-09-14 07:53 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `165f3c34` mcp/server.py: first full cold-read of the MCP distribution  |
