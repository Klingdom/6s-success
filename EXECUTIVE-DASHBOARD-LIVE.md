...
> Generated 2026-09-17 18:09 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Stream | State |
|---|---|
| Traffic | 952 pageviews from 78 visitors across 201 visits, 2026-08-20 to 2026-09-17. **441 of those pageviews came from 2 automated session(s)**, leaving 511 from 76 visitors. The remainder is not the same as strangers: it still includes Phil and any check run from a real browser. |
...
| Closed to date | 25 |
| Commits (7 days) | 1262 of 2625 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `31722d48` Nightly log: the picture batch, its four exposed defects, an |
