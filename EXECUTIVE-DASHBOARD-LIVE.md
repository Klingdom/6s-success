...
> Generated 2026-08-31 06:29 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 368 of 613 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `9080254c` Make the heredoc rule enforceable instead of writing it down |
