...
> Generated 2026-08-29 22:47 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `97924f2` Media capability: the GPU is live, and two of my own checks  |
