...
> Generated 2026-09-25 07:38 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1092 of 3797 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `58c234fe` PM check-in log: deploy-gap staleness correction, full prefl |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 201 pages, 0 dead links, 4/4 legal pages, 197 disconnected forms |
