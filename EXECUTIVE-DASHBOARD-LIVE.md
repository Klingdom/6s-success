...
> Generated 2026-09-23 15:51 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1163 of 3534 total |
| Working tree | clean, in sync |
| Last commit | `c56673b9` Document preflight's timeout gotcha at the source: the lock  |
