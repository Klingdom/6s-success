...
> Generated 2026-09-10 05:05 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 496 of 1264 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `c4443d94` Harden preflight's pymupdf bootstrap against a cold-tunnel n |
