...
> Generated 2026-09-09 03:11 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 449 of 1172 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `cb60f048` Update STATUS.md: MCP fix confirmed deployed, caption work r |
