...
> Generated 2026-09-25 21:20 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1089 of 3899 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `3e527915` Nightly log entry and command deck regen for the wire_landma |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 204 pages, 0 dead links, 4/4 legal pages, 200 disconnected forms |
