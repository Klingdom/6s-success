...
> Generated 2026-09-16 03:53 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 24 |
| Commits (7 days) | 1119 of 2292 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `89c7ac4f` Fix stale RISK-0003 in RISKS.md, closed evidence still read  |
