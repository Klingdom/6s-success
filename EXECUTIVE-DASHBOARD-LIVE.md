...
> Generated 2026-09-15 01:03 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 1008 of 2077 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `847beec2` Fix gate_etsy_pdfs_current leaving preview PNGs dirty; regen |
