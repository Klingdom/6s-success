...
> Generated 2026-09-13 11:43 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 846 of 1784 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `fd39de1e` Fix build_etsy_assets.py profile-lock race that broke CI, an |
