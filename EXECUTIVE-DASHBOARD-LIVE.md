...
> Generated 2026-09-17 23:50 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1256 of 2619 total |
| Working tree | clean, in sync |
| Last commit | `fe213300` An EPUB rebuilt here is byte-different and content-identical |
