...
> Generated 2026-09-17 00:08 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 24 |
| Commits (7 days) | 1181 of 2436 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `837e0bf7` Store art: close a staleness gap that could ship the wrong p |
