...
> Generated 2026-09-21 09:13 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1221 of 3173 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `5868011b` Fix ops/ship.py dropping a new-file-only commit; add regress |
