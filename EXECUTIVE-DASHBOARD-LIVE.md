...
> Generated 2026-09-03 20:57 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 435 of 790 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `c760398d` Fix the stale published-video count that was failing real CI |
