...
> Generated 2026-09-05 13:12 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 472 of 897 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `50957a79` Extend gate_visual_audit to all 9 audit_visual.py categories |
