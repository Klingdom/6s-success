...
> Generated 2026-09-12 13:59 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 754 of 1652 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `c3a2a861` ROADMAP-2026-2029.md: remove a duplicate site-age claim that |
