...
> Generated 2026-09-09 19:32 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 472 of 1225 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `c2b7d07c` Fold O4 into Phil's finalised affiliate-hold decision |
