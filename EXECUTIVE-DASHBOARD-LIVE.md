...
> Generated 2026-09-19 01:19 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1262 of 2830 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `0c62fc6a` Merge same-category hazard entries so a zone never shows one |
