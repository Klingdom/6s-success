...
> Generated 2026-09-25 02:54 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1077 of 3755 total |
| Working tree | clean, in sync |
| Last commit | `050273ae` Fix gate_cold_read_handoff_not_stale: recognize 'Handing to  |
