...
> Generated 2026-08-27 11:33 by `ops/dashboard.py`. Every figure is measured, not typed.
...
The site can take money for 158 of 159 catalog items, each a live Stripe Payment Link or a real free download. Still not buyable: Corporate Lean 6S. All 183 forms still hand off to email by hand instead of capturing a list. The widened catalog has not moved revenue because almost nobody is arriving at the site yet. Discovery, not what can be bought, is the constraint now.
...
| Commits (7 days) | 245 of 350 total |
| Working tree | clean, in sync |
| Last commit | `b10a278` Wire the generated packs to Stripe: 155 buyable, every one d |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 186 pages, 0 dead links, 4/4 legal pages, 183 disconnected forms |
