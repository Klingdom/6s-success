...
> Generated 2026-09-16 23:23 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 24 |
| Commits (7 days) | 1181 of 2432 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `5435af2d` llms.txt: name the Standards Pack, and make the gate enforce |
