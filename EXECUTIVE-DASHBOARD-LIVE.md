...
> Generated 2026-09-25 19:21 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `9dd57635` Fix product_links.py --check: withdraw a dead link, not just |
