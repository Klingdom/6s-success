...
> Generated 2026-09-25 07:21 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1090 of 3795 total |
| Working tree | clean, in sync |
| Last commit | `d0e6c9c0` STATUS.md: BLOCKER-001's deploy-gap citation was one commit  |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 201 pages, 0 dead links, 4/4 legal pages, 196 disconnected forms |
