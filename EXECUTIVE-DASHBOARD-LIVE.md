...
> Generated 2026-08-31 03:48 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `60f1494` Regenerate the command deck |
...
- **Redeploy the site.** Production is serving an older build: 0 of 0 assets on the live homepage differ from this repository, and no zone page carries its photograph yet. The image is built and pushed to ghcr.io; the Redeploy button in Hostinger is the only step left. Until then 110 reviewed pictures and every fix since the last deploy reach nobody.
