...
> Generated 2026-09-09 00:06 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 440 of 1160 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `cf51b6bf` Wire ops/diagnosis.py's schema check into preflight, gated |
