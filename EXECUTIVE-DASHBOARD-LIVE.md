...
> Generated 2026-09-01 06:48 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 402 of 678 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `b74b5438` roadmap_report.py: fix gh-failure collapsing to zero issues, |
