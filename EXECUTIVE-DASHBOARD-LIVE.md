...
> Generated 2026-09-10 22:56 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 561 of 1356 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `028e3be7` Fix caption line-length budget violated in video_srt.py's wr |
