...
> Generated 2026-09-22 20:12 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 26 |
| Commits (7 days) | 1189 of 3426 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `577ef295` Merge origin/main: no conflict with the catalogue-count fix |
