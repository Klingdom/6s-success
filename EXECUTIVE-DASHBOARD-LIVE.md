...
> Generated 2026-09-18 00:01 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1255 of 2618 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `f3f3d58f` Log the reconciled merge and the EPUB gate near-miss, regene |
