...
> Generated 2026-09-25 19:14 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1082 of 3882 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `6eabab05` Close B8 by decision: room-deck card counts stay corpus-hone |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 205 pages, 0 dead links, 4/4 legal pages, 200 disconnected forms |
