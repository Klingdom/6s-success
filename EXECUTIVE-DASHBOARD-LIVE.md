...
> Generated 2026-09-26 16:54 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1102 of 4014 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `52d2a628` Fix audit_visual.py's exit code to reflect all 9 measured ca |
