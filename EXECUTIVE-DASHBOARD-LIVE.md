...
> Generated 2026-08-19 12:45 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 6 |
| Commits (7 days) | 65 of 71 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `471af95` Give the zone pages somewhere to go |
