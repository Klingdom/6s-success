...
> Generated 2026-09-07 19:00 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 374 of 1032 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `773b72b8` Catch a failed publish leaving real fixes unpublished, and f |
