...
> Generated 2026-09-01 04:00 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 402 of 675 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `2c8dc541` Wire 6 orphaned root-cause articles into the zone link graph |
