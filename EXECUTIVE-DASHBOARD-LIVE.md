...
> Generated 2026-09-09 13:12 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 462 of 1200 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `166f4643` Fix cheapest-first sort in media_capability.py, add regressi |
