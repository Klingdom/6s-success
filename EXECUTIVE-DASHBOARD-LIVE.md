...
> Generated 2026-09-17 23:44 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1257 of 2617 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `fbe8ba12` Gate: don't fail generator-ownership on build_epub.py in a t |
