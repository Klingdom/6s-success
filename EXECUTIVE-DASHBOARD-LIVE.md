...
> Generated 2026-09-15 22:57 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `e50c8048` Revenue arithmetic: the site's own checkout-conversion rate  |
