...
> Generated 2026-09-25 16:05 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1100 of 3863 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `4a62b73c` PM check-in: clear a real preflight FAIL, same lockdir shape |
