...
> Generated 2026-08-31 09:50 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 358 of 599 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `01eab7b7` Retrospective, cycle 25: the ownership gate now proves it ca |
