...
> Generated 2026-09-13 08:55 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 832 of 1765 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `57170ca4` Fix stale create-DATA-SOURCES.md instruction in METRICS.md |
