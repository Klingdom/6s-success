...
> Generated 2026-09-10 19:52 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 538 of 1327 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `133bd10c` PM check-in: correct a stale cold-read handoff, hand DECISIO |
