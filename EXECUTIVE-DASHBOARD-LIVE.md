...
> Generated 2026-09-11 02:04 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `a83316dd` Cold-read six standing candidate files, no new defect |
