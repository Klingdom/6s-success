...
> Generated 2026-09-25 03:08 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1079 of 3758 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `0d45b04d` Merge concurrent cold-read-handoff gate fix |
