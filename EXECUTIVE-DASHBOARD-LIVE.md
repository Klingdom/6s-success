...
> Generated 2026-09-13 03:10 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 801 of 1727 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `0c2290ec` Gate the page-ownership classification the cold-read lane re |
