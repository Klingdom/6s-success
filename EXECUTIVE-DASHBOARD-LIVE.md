...
> Generated 2026-09-02 13:14 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 431 of 739 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `9fa600e8` Fix em dashes and stale on-device check count in today's fou |
