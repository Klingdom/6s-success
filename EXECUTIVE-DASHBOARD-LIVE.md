...
> Generated 2026-09-10 17:57 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 527 of 1313 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `02d67e52` Fix stale organic-search claims in RISKS.md, widen the gate  |
