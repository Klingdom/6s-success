...
> Generated 2026-09-10 17:16 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 523 of 1308 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `ac03c6d2` Regenerate the deck after the root_causes.py / general_readi |
