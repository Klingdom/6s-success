...
> Generated 2026-09-22 04:47 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1203 of 3315 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `dfdb88ab` corpus_index.py: classify 5 more finished per-chapter conten |
