...
> Generated 2026-08-29 20:45 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `84ca2de` Fix the fresh-sandbox gate itself: preflight self-heals unco |
