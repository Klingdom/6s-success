...
> Generated 2026-09-25 00:27 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1108 of 3736 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `47afa6b7` PM check-in: correct a doubly-stale deploy-gap citation, hea |
