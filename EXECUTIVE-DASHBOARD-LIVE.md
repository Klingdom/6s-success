...
> Generated 2026-09-03 03:58 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 431 of 766 total |
| Working tree | clean, in sync |
| Last commit | `b1179953` Fix the KDP cover's Windows-only font wall with fonts alread |
