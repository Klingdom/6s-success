...
> Generated 2026-09-19 09:28 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1247 of 2874 total |
| Working tree | clean, in sync |
| Last commit | `2b445afe` Fix roadmap-report.yml picking the wrong edition (and wrong  |
