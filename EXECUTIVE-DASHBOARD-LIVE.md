...
> Generated 2026-09-09 04:07 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 449 of 1173 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `1292dece` Close A5: quest-cause-shown, quest-card-abandoned, quest-ret |
