...
> Generated 2026-09-21 11:08 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1214 of 3181 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `62a209e5` Close handed-off preflight --deep run; correct a stale MARKE |
