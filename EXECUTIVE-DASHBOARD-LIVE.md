...
> Generated 2026-09-25 16:10 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1099 of 3864 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `659121f2` Fix stale hardcoded word count in the status report Phil rea |
