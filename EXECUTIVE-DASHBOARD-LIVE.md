...
> Generated 2026-09-03 18:00 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 434 of 786 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `80e25ea2` Run the narration batch detached so it finishes without baby |
