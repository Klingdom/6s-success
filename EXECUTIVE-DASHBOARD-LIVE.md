...
> Generated 2026-09-22 18:25 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 26 |
| Commits (7 days) | 1190 of 3417 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `15ed727c` PM: close the stale C6/C7 deploy/live-verify/archive claim i |
