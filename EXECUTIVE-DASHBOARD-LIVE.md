...
> Generated 2026-09-11 13:04 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 626 of 1465 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `0d7aee7e` Untrack 5 fossil files in build/card-fronts/, gate the whole |
