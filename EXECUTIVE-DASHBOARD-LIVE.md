...
> Generated 2026-09-11 10:06 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 613 of 1447 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `7670d85f` Nightly: verify cold-read tier exhaustion mechanically, corr |
