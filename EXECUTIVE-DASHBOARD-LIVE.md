...
> Generated 2026-09-17 09:03 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Stream | State |
|---|---|
| Traffic | 948 pageviews from 78 visitors across 199 visits, 2026-08-20 to 2026-09-17. **441 of those pageviews came from 2 automated session(s)**, leaving 507 from 76 visitors. The remainder is not the same as strangers: it still includes Phil and any check run from a real browser. |
...
| Last commit | `0e7ac6f9` Retract a false claim I published: the deploy watchers exist |
