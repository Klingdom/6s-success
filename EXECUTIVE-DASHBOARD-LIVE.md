...
> Generated 2026-09-14 11:02 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 969 of 1964 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `d02c31ef` Fix QA-review honesty gaps; add .gitattributes and a binary- |
