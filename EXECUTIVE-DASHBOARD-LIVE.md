...
> Generated 2026-09-12 16:07 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 756 of 1663 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `5f5138b7` Correct DATA-SOURCES.md's frozen "every source UNVERIFIED" c |
