...
> Generated 2026-09-20 14:20 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| **Revenue this month** | **$0 of $20,000 target (0.0%), carried forward from 2026-09-18 15:10 because this run could not reach Stripe** |
| | `............................` |
| **Paying customers** | 0 |
| **Email list** | 0 |
...
| Stream | State |
|---|---|
| Traffic | 968 pageviews from 79 visitors across 206 visits, 2026-08-20 to 2026-09-18. **441 of those pageviews came from 2 automated session(s)**, leaving 527 from 77 visitors. The remainder is not the same as strangers: it still includes Phil and any check run from a real browser. (carried forward from 2026-09-18 15:10; this run could not measure it fresh: **not measured** (no ssh key at /root/.ssh/6s_deploy, so the database was not reached). No number here means nobody looked, not that nobody came.) |
...
| Closed to date | 25 |
| Commits (7 days) | 1218 of 3041 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `9ab4cd09` Refresh command deck after clean post-merge preflight reconf |
...
| Zone reset videos | 114/114 short zone-reset videos, rendered, not posted anywhere yet (carried forward from 2026-09-18 15:10: build/video/*.mp4 is no longer tracked in git, so this could not be measured here) |
| Zone reset videos, photo-led | 2/111 eligible photo-led zone-reset videos, rendered, not posted anywhere yet (carried forward from 2026-09-18 15:10: build/video/*.mp4 is no longer tracked in git, so this could not be measured here) |
| Zone reset videos, 16:9 for YouTube | 114/114 horizontal zone-reset videos for YouTube, rendered, not posted anywhere yet (carried forward from 2026-09-18 15:10: build/video/*.mp4 is no longer tracked in git, so this could not be measured here) |
| Zone reset videos, narrated | 113/114 narrated zone-reset videos with real voice, rendered, not posted anywhere yet (carried forward from 2026-09-18 15:10: build/video/*.mp4 is no longer tracked in git, so this could not be measured here) |
