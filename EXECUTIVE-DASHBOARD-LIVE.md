...
> Generated 2026-09-10 21:19 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 545 of 1337 total |
| Working tree | clean, in sync |
| Last commit | `4cba62e6` PM check-in: DECISIONS.md spot-checked against today's known |
