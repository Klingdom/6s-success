...
> Generated 2026-09-25 03:20 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1076 of 3756 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `1c9e5f7e` Regenerate command deck after the cold-read-handoff gate fix |
