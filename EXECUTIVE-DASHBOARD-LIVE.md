...
> Generated 2026-08-28 14:48 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `e6a3e5f` One prompt file, a drop folder, and an importer that checks  |
