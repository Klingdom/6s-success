...
> Generated 2026-08-30 23:02 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 329 of 561 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `63cd193` Fix three more layout defects at 360px, and one self-contrad |
