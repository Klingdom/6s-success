...
> Generated 2026-09-08 02:14 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 22 |
| Commits (7 days) | 409 of 1083 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `75917a42` Fix the live CI break, and close A4: already done, nobody ha |
