...
> Generated 2026-09-17 22:27 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1245 of 2600 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `527e5ece` Fix a red preflight gate: the new AVIF-srcset test crashes w |
