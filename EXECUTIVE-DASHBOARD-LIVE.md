...
> Generated 2026-09-16 10:00 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 24 |
| Commits (7 days) | 1144 of 2335 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `f0b5abf5` Fix GOALS.md's own video-publishing baseline: 12 of 228, not |
