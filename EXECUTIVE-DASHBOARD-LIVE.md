...
> Generated 2026-09-21 03:18 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1218 of 3135 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `ec14a80b` D12: add a direct answer above the fold to all six specific  |
