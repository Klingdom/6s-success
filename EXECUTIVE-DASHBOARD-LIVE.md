...
> Generated 2026-09-02 03:49 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 424 of 723 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `6af513a4` Chain the whole-site wiring passes into build_resources.py |
