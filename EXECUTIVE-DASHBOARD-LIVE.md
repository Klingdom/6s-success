...
> Generated 2026-09-10 17:14 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 524 of 1307 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `7eb2f078` root_causes.py said EXCESS had no article two days after one |
