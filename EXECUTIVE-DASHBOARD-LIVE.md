...
> Generated 2026-09-13 11:56 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 849 of 1787 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `1c57c426` Diagnostic only: surface the real gate/browser output in tes |
