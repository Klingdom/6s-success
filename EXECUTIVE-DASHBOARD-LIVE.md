...
> Generated 2026-09-11 17:06 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 649 of 1501 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `38916007` Fix render_all_zone_videos.py's zones() to read structured d |
