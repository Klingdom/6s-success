...
> Generated 2026-09-13 03:45 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 803 of 1729 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `fb09363e` PM check-in: cold-read site/deck.html, genuinely clean |
