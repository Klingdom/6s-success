...
> Generated 2026-09-11 14:26 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 637 of 1478 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `33ec1423` Regenerate command deck against current HEAD |
