...
> Generated 2026-09-21 12:18 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1211 of 3187 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `cbd649d8` Add regression test coverage for crawl_report.py's log-line  |
