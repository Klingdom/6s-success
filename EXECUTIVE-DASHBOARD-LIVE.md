...
> Generated 2026-09-13 12:03 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 850 of 1788 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `3b7480ba` Diagnostic v2: put the regenerator's own exit code and stdou |
