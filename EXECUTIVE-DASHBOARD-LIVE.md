...
> Generated 2026-09-01 15:35 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 419 of 711 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `18ed6887` Chain the AVIF wiring into all six generators, which is why  |
