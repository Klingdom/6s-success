...
> Generated 2026-09-11 05:25 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 595 of 1418 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `eed57440` Fix stale article count in llms.txt, gate it against the rea |
