...
> Generated 2026-09-18 05:52 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1274 of 2694 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `47b2cc0e` PM check-in: derive the dashboard's zones-with-deck figure i |
