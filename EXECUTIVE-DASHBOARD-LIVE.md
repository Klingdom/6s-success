...
> Generated 2026-08-31 03:02 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 356 of 596 total |
| Working tree | clean, in sync |
| Last commit | `0485d2b` Let the ownership gate run in CI by checking what CI can act |
