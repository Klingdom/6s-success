...
> Generated 2026-09-19 19:16 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1241 of 2925 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `bbdbdbc9` video.py --probe: report MISSING instead of crashing when ff |
