...
> Generated 2026-09-18 16:18 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1269 of 2765 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `aa209d21` The method page now says what the six moves are applied to |
