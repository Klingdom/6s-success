...
> Generated 2026-09-10 17:06 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 524 of 1306 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `3d44347f` Regenerate the deck after the PM check-in |
