...
> Generated 2026-09-02 02:56 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 424 of 722 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `ebb8b736` Fix mobile Quest finish screen: two buttons did the same thi |
