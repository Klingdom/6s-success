...
> Generated 2026-09-04 23:07 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 469 of 869 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `0162eedf` Fix 36 heading-level jumps in the free sample eBook (h1->h4, |
