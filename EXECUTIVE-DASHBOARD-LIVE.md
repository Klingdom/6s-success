...
> Generated 2026-09-10 19:09 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 532 of 1320 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `f2f77879` Fix build_sample_html.py stripping its own cache-busting fin |
