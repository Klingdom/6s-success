...
> Generated 2026-09-06 15:02 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 490 of 947 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `c9a46a6d` Nightly log: confirm CI green on the status_of() coverage fi |
