...
> Generated 2026-09-13 08:19 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 828 of 1760 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `e104dcd1` PM check-in: root operating-doc mention count ranked, stale  |
