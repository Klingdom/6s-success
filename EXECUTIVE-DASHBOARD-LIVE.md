...
> Generated 2026-09-12 23:54 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 788 of 1709 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `10edd3ba` Operator cycle: cold-read build/listings/*.py tier, no defec |
