...
> Generated 2026-09-11 06:00 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 593 of 1421 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `90e45539` Fix a stale book word count invisible to its own gate, widen |
