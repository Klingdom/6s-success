...
> Generated 2026-09-06 12:55 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 490 of 943 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `bb51b42f` Add missing test coverage for check_live_links.py's own verd |
