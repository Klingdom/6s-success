...
> Generated 2026-09-22 04:59 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1206 of 3320 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `a4fb80d4` NIGHTLY-LOG.md: record the merge commit hash and honest CI-p |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 197 pages, 0 dead links, 4/4 legal pages, 192 disconnected forms |
...
| Social corpus | ~5,040 ready-to-publish units, unused |
