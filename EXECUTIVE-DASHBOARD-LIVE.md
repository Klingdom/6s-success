...
> Generated 2026-08-31 20:51 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 404 of 667 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `84c04cce` Deck goes RED to YELLOW: the site can take money again |
