...
> Generated 2026-09-11 06:55 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 597 of 1425 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `11d9614c` PM check-in: log the EXP-101 fix and hand EXPERIMENTS.md to  |
