...
> Generated 2026-09-01 15:43 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 421 of 713 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `f20ec1fc` Deck refresh: production is current, 159 products live |
