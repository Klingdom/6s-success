...
> Generated 2026-09-22 11:26 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 26 |
| Commits (7 days) | 1200 of 3368 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `3c5a45c4` Fix ops/ship.py --help/-h silently shipping and attempting a |
