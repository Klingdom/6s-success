...
> Generated 2026-09-12 05:22 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 715 of 1598 total |
| Working tree | clean, in sync |
| Last commit | `c1970b68` PM check-in: close two stale plan-doc rows found true, flag  |
