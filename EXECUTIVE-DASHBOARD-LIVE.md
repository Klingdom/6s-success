...
> Generated 2026-08-21 15:37 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 6 |
| Commits (7 days) | 132 of 138 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `125ac1a` Tell search engines this site sells things, and where its pa |
