...
> Generated 2026-09-09 05:05 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 452 of 1177 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `09c75077` Quest: close the M7/A1 stale-plan finding, not the fix Phil  |
