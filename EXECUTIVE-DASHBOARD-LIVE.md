...
> Generated 2026-09-16 14:53 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 24 |
| Commits (7 days) | 1159 of 2363 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `edfd0c9d` Regen mobile corpus stale against quest-data.js; fix dashboa |
