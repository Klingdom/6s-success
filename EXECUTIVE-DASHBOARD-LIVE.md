...
> Generated 2026-09-24 10:52 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Last commit | `029a85e8` PM check-in: diagnose and clear self-inflicted preflight loc |
