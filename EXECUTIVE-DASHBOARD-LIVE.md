...
> Generated 2026-09-20 10:06 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Stream | State |
|---|---|
| Traffic | 971 pageviews from 80 visitors across 208 visits, 2026-08-20 to 2026-09-20. **441 of those pageviews came from 2 automated session(s)**, leaving 530 from 78 visitors. The remainder is not the same as strangers: it still includes Phil and any check run from a real browser. |
...
| Closed to date | 25 |
| Commits (7 days) | 1217 of 3060 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `6d3f7a16` STATUS: sync the organic-search row with today's measurement |
