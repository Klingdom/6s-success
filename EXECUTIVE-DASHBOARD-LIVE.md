...
> Generated 2026-09-01 04:58 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 20 |
| Commits (7 days) | 402 of 676 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `98cbaf02` Fix status_report.py reporting unreachable/blocked network p |
