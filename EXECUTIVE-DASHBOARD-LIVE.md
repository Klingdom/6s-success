...
> Generated 2026-09-11 19:28 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 23 |
| Commits (7 days) | 655 of 1517 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `3165d484` Fix cause_reading() silently dropping two mapped root-cause  |
