...
> Generated 2026-09-07 18:29 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 21 |
| Commits (7 days) | 373 of 1030 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `1b2960d6` Nightly log and backlog row for this cycle's CI-red chase |
