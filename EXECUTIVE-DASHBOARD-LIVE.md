...
> Generated 2026-09-25 14:33 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 27 |
| Commits (7 days) | 1102 of 3848 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `4ebb4625` Fix STATUS.md citing a superseded deploy-verdict confirmatio |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 210 pages, 0 dead links, 4/4 legal pages, 200 disconnected forms |
