...
> Generated 2026-09-03 06:53 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| **Revenue this month** | **$0 of $20,000 target (0.0%), carried forward from 2026-09-02 07:30 because this run could not reach Stripe** |
| | `............................` |
| **Paying customers** | 0 |
| **Email list** | 0 |
...
| Closed to date | 20 |
| Commits (7 days) | 431 of 769 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `3be1590b` Gitignore and gate a stray audit_visual.py probe file this c |

## Product readiness

| Product | Measured state |
|---|---|
| Website | 191 pages, 0 dead links, 4/4 legal pages, 188 disconnected forms |
...
| Zone imagery | 110/114 zone pages carry a reviewed picture (live) |
