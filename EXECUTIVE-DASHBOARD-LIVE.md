...
> Generated 2026-09-22 11:04 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 26 |
| Commits (7 days) | 1200 of 3363 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `4b792857` Fix Product JSON-LD url drift on shop.html after the bundle  |
