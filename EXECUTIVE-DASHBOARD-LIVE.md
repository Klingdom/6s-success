...
> Generated 2026-09-17 14:02 by `ops/dashboard.py`. Every figure is measured, not typed.
...
| Closed to date | 25 |
| Commits (7 days) | 1245 of 2530 total |
| Working tree | uncommitted or unpushed work |
| Last commit | `bfaa2358` Fix gate_publish_image_current failing on itself: a duplicat |
