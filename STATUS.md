...
**Production Knowledge:** LAST CONFIRMED CURRENT 2026-09-15T11:17:08Z (build `346c043b56385f64`, `ops/deploy-verdict.json`, A SESSION WITH REAL VPS ACCESS, COMMITTED IN `a064f2fa` AFTER THE VERIFIED DEPLOY). THIS IS THE SAME BUILD `site/build-id.txt` CARRIES AS OF THIS ENTRY, SO PRODUCTION AND THE REPOSITORY MATCH; THE EARLIER "NOT YET REDEPLOYED" READING IN THIS FILE (WRITTEN 11:20:39Z, BEFORE THAT DEPLOY WAS COMMITTED) IS SUPERSEDED. NO OPERATOR SANDBOX HOLDS THE DEPLOY KEY'S PRIVATE HALF OR EGRESS TO THE VPS, SO NEITHER A FRESH CHECK NOR A REDEPLOY IS POSSIBLE FROM HERE; TREAT VPS ACCESS AS PER-SESSION, NOT UNIFORMLY AVAILABLE.
