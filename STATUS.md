...
**Updated By:** Claude, PM check-in (30-minute triage). Checkout arrived shallow and detached; unshallowed, `git fetch --unshallow` then ff-only onto `origin/main` (`af218da2`), clean.
